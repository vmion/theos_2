...
public class _01_VillageParser : ParserManager<_01_VillageParser, MapData>
{
    Dictionary<int, Transform> createdList = new Dictionary<int, Transform>();
    public override void ReadData(string[] _datas)
    {
        GameObject TerrainParent = GameObject.Find("Ground");
        if (TerrainParent == null)
        {
            TerrainParent = new GameObject("Ground");
