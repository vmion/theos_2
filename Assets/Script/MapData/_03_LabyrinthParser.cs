...
public class _03_LabyrinthParser : ParserManager<_03_LabyrinthParser, MapData>
{
    Dictionary<int, Transform> createdList = new Dictionary<int, Transform>();
    public override void ReadData(string[] _datas)
    {
        GameObject TerrainParent = GameObject.Find("Labyrinth");
        if (TerrainParent == null)
        {
            TerrainParent = new GameObject("Labyrinth");
        ...
        GameObject tmp = Resources.Load<GameObject>("_03_Labyrinth_Resources/" + rcName);
