...
public class _02_ForestParser : ParserManager<_02_ForestParser, MapData>
{
    Dictionary<int, Transform> createdList = new Dictionary<int, Transform>();
    public override void ReadData(string[] _datas)
    {
        GameObject TerrainParent = GameObject.Find("Forest");
        if (TerrainParent == null)
        {
            TerrainParent = new GameObject("Forests");
        ...
        GameObject tmp = Resources.Load<GameObject>("_02_Forest_Resources/" + rcName);
